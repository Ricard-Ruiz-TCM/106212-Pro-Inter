...
namespace MoonSharp.Interpreter.Loaders
{
	...
	public class UnityAssetsScriptLoader : ScriptLoaderBase
	{
        ...
        public string DEFAULT_PATH = Application.streamingAssetsPath + "Lua"; //Changed to Lua folder
		...
		private string GetFileName(string filename)
		{
            ...
            //filename = System.IO.Path.GetFileNameWithoutExtension(filename); ///Remove the .txt
